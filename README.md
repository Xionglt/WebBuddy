...
- [docs/golden-problems.md](./docs/golden-problems.md)
- [docs/form-autofill-design.md](./docs/form-autofill-design.md)
...
7. 真实投递前阅读 `docs/safety-model.md`、`docs/golden-problems.md`、
   `docs/form-autofill-design.md`，确认 final submit 和 quota 弹窗边界。
