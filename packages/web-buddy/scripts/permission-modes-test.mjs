...
function loginRequest(id) {
  return permissionRequest({
    ...
    policyAuditTags: ['action:gate', 'risk:high', 'workflow', 'external_blocker', 'human_handoff', 'gate:login'],
  })
}
...
function captchaRequest(id) {
  return permissionRequest({
    ...
    policyAuditTags: ['action:gate', 'risk:high', 'workflow', 'external_blocker', 'human_handoff', 'gate:captcha'],
  })
}
