...
`claude-code` 是 [multi-functional-agent](../../README.md) 项目中可选的外部 Agent runtime，用于保留恢复版 Claude Code runtime 路径。

## 项目概述

这个包源自 Claude Code 2.1.88 恢复源码的重构版本，整理为标准 npm 工程，便于：
